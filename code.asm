...
; --- END: outputArrayElement() for sum2--- 
	...
	sub rdx, 8d
	mov word [rdx], ax
; --- START: moveOffsetToOffset(): lhsoff = 38, rhsoff = 6, type = Integer ---
	mov rax, rsp
	sub rax, 8d
	mov r8w, word [rax]
	mov rax, rbp
	sub rax, 40d
	mov word [rax], r8w
; --- END: moveOffsetToOffset(): lhsoff = 38, rhsoff = 6, type = Integer ---
; --- START: giveInput() type: AST_NODE_VARIDNUM --- 
	mov rax, rbp
	sub rax, 32d
	mov r10w, word [rax]
...
; --- START: applyOperator(): leftOp: 0, rightOp: 2, operator: PLUS, type: Integer --- 
	...
	mov word [rax], r8w
; --- START: applyOperator(): leftOp: 0, rightOp: 2, operator: PLUS, type: Integer --- 
; --- START: moveOffsetToOffset(): lhsoff = 38, rhsoff = 4, type = Integer ---
	mov rax, rsp
	sub rax, 6d
	mov r8w, word [rax]
	mov rax, rbp
	sub rax, 40d
	mov word [rax], r8w
; --- END: moveOffsetToOffset(): lhsoff = 38, rhsoff = 4, type = Integer ---
; --- START: giveInput() type: AST_NODE_VARIDNUM --- 
	mov r9, 40d
	mov rdx, rbp
