		...
		switch(option) {
			...
			case 3: {
				...
				if(syntacticallyCorrect) {
					...
					fprintf(stderr, KRED "AST not generated due to syntactic errors, hence it was not printed\n" KNRM);
				}
			...
			case 4: {
				...
				if(syntacticallyCorrect) {
					...
					/* Syntactically incorrect. Report error instead */
					fprintf(stderr, KRED "AST not generated due to syntactic errors, hence no computation was possible\n" KNRM);
				}
			}
			break;
			...
			case 5: {
				...
				if(syntacticallyCorrect == False) {
					fprintf(stderr, KRED "Symbol Table not generated due to syntactic errors\n\n" KNRM);
					break;
				}
			...
			case 6: {
				...
				if(syntacticallyCorrect == False) {
					fprintf(stderr, KRED "Activation Record not generated due to syntactic errors\n\n" KNRM);
					break;
				}
			...
			case 7: {
				...
				if(syntacticallyCorrect == False) {
					fprintf(stderr, KRED "Type expression and widths of arrays not generated due to syntactic errors\n\n" KNRM);
					break;
				}
			...
			case 8: {
				...
				if(syntacticallyCorrect == False) {
					fprintf(stderr, KRED "Semantic tests not performed due to syntactic errors\n\n" KNRM);
					break;
				}
				...
				printf(KMAG "Total CPU Time" KNRM ": %lf ticks (= %lf seconds)\n\n", total_CPU_time,total_CPU_time_in_seconds);
			}
			break;
			...
			case 9: {
				...
				if(syntacticallyCorrect == False) {
					fprintf(stderr, KRED "Semantic check not performed due to syntactic errors\n\n" KNRM);
					break;
				}
				...
				if(syntacticallyCorrect && semanticallyCorrect) {
					...
					fprintf(stderr, KRED "Code not generated due to semantic errors\n" KNRM);
				}
			}
			break;
